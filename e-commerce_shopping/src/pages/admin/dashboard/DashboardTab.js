...
function DashboardTab() {
  ...
  const { mode, product, editProduct, deleteProduct, order,user } = context;
  // console.log(product);
                  ...
                  <tbody>
                    ...
                    order.map((allorder, orderindex) =>
                      allorder.cartItems.map((item, itemindex) => {        
                        ...
                        return (
                          <tr
                            key={`${orderindex}-${itemindex}`} // Unique key using both indices
                            className="bg-gray-50 border-b dark:border-gray-700"
                            style={{
                              backgroundColor:
                                mode === "dark" ? "rgb(46 49 55)" : "",
                          ...
                          >
                            ...
                            >
                              {itemindex +
                                1 +
                                allorder.cartItems.length * orderindex}{" "}
                              {/* Adjust for SR No. */}.
                            </td>
                            <td
                              className="px-6 py-4 text-black"
