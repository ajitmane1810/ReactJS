...
const ProductInfo = () => {
  ...
  const getProductData = async ()=>{
    try {
      ...
      console.log("getProductData on ProductInfo "+error);
          ...
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="flex">
                ...
                <button onClick={handleSignupClick} className="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">
                    Signup
              </button>
